...
trait ImageListSettings{
	...
	protected function renderImageList() {
		$settingsImageList = $this->get_settings_for_display(); ?> 
            ...
            <div class="img-list-wrap d-flex <?php echo $settingsImageList['image_list_list_block'] ? 'flex-column' : 'flex-wrap'; ?>">
                <?php foreach ($settingsImageList['image_list_repeter'] as $list) {
					...
					<<?php echo $tag ?> <?php echo $links; ?> class="img__item d-flex align-items-center elementor-repeater-item-<?php echo $list['_id']; ?> <?php echo $settingsImageList['image_list_show_border'] ? "has-wrap-border" : ""; ?>">
						<img src="<?php echo wp_get_attachment_image_url($list['list_image']['id'], 'full') ?>" alt="">
					</<?php echo $tag ?>>
